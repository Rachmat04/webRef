...
window.webRef.getRef = (function () {
	...
	var andWords = ['dan'];  // LOCALIZE by adding the word(s) for "and" in the local lang
	...
	var templateParams = { // LOCALIZE
		...
		title: 'title',
		transTitle: 'trans-title', // the title translated to Indonesian
		work: 'work',
		date: 'date',
	...
	var langToIgnore = 'id'; // default lang of the wiki - won't be specified in the cite template  // LOCALIZE
	...
	function makeRefName(title) {
		...
		return domain + '_' + firstWord + '_' + middleWord + '_' + lastWord;
}
